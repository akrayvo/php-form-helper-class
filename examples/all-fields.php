...
<body>
	...
	$text = 'Show / Hide Info';
	$attributes = array('onclick' => 'toggleInfo()');
	$form->button($text, $attributes);
	
    $form->formStart(null, 'get', array('name' => 'my-form')); ?>
    ...
    <div class="inputContainer">
        ...
        <ul class="formInfo">
            ...
            <li>"onchange" attribute is set to display the
    ...
    <div class="inputContainer">
        <label for="next_birthday">Next Birthday Date</label>
    ...
    <div class="inputContainer">
        ...
        <ul class="inputList">
            <li>
                <?php $form->checkbox('hobby_movies', $hobby_movies); ?>
                <label for="hobby_movies">Watching Movies</label>
            </li>
            <li>
                <?php $form->checkbox('hobby_sports', $hobby_sports); ?>
                <label for="hobby_sports">Playing Sports</label>
            </li>
            <li>
                <?php $form->checkbox('hobby_books', $hobby_books); ?>
    ...
    <div class="inputContainer">
        ...
        <ul class="inputList">
			...
			foreach ($foods as $key => $display) {
				...
				echo '<li>';
				$form->checkbox('food[' . $key . ']', $isChecked, 1, array('id' => $id));
    ...
    <div class="inputContainer">
        ...
        <ul class="inputList">
            <li>
                <?php $form->radio('movie', 'star_wars', $movie, array('id' => 'star_wars')); ?>
                <label for="star_wars">Star Wars</label>
            </li>
            <li>
                <?php $form->radio('movie', 'sound_of_music', $movie, array('id' => 'sound_of_music')); ?>
                <label for="sound_of_music">Sound Of Music</label>
            </li>
            <li>
                <?php $form->radio('movie', 'avatar', $movie, array('id' => 'avatar')); ?>
    ...
    <div class="inputContainer">
        ...
        <ul class="inputList">
			...
			foreach ($shows as $key => $display) {
				$id = 'show_' . $key;
				echo '<li>';
				$form->radio('show', $key, $show, array('id' => $id));
				echo '<label for="' . $id . '">' . $form->htmlEscape($display) . '</label>';
				echo '</li>';
			}
			?>
    ...
    <div class="inputContainer">
        ...
        <?php $form->textarea('comments', $comments, array('style' => 'height:80px;')); ?>
        <ul class="formInfo">
            <li>&lt;textarea&gt;</li>
        </ul>
    </div>
    ...
    <div class="inputContainer">
        ...
        <?php
		$states = array(
			array('id' => 34, 'abbreviation' => 'AZ', 'name' => 'Arizona', 'capital' => 'Phoenix'),
			array('id' => 38, 'abbreviation' => 'CA', 'name' => 'California', 'capital' => 'Sacramento'),
			array('id' => 49, 'abbreviation' => 'NY', 'name' => 'New York', 'capital' => 'Albany')
            );
		$form->selectByRecordSet('state', $states, 'id', 'name', '-- Select A State --', $state);
		?>
        <ul class="formInfo">
            <li>&lt;select&gt;&lt;option&gt;&lt;/option&gt;&lt;/select&gt;</li>
